...
import fr.persee.config.ApplicationProperties;
import fr.persee.config.DefaultProfileUtil;
...
@EnableZuulProxy
public class PerseeApp {

    private static final Logger log = LoggerFactory.getLogger(PerseeApp.class);

    private final Environment env;

    public PerseeApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PerseeApp.class);
