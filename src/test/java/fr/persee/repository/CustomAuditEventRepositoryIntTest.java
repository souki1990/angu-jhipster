...
import fr.persee.config.audit.AuditEventConverter;
import fr.persee.domain.PersistentAuditEvent;
...
import static fr.persee.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
