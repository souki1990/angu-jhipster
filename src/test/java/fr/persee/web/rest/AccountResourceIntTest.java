...
import fr.persee.config.Constants;

import fr.persee.PerseeApp;
import fr.persee.domain.Authority;
import fr.persee.domain.User;
import fr.persee.repository.AuthorityRepository;
import fr.persee.repository.UserRepository;
import fr.persee.security.AuthoritiesConstants;
import fr.persee.service.MailService;
import fr.persee.service.UserService;
import fr.persee.service.dto.UserDTO;
import fr.persee.web.rest.vm.KeyAndPasswordVM;
import fr.persee.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = PerseeApp.class)
